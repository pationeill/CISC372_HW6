...
int main(int argc, char **argv)
{
    ...
    dest_d = (float*)malloc(sizeof(float) * pWidth * height);
    //mid_d = (float*)malloc(sizeof(float) * pWidth * height);
    ...
    cudaMemcpy(img, dest_img, sizeof(uint8_t) * pWidth * height, cudaMemcpyHostToDevice);
    cudaMemcpy(dest, dest_d, sizeof(float) * pWidth * height, cudaMemcpyHostToDevice);
    //cudaMemcpy(mid, mid_d, sizeof(float) * pWidth * height, cudaMemcpyHostToDevice);
